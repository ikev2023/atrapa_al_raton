...
const audiofinal = new Audio("final.mp3");
const audiofondo = new Audio("fondo1.mp3");
const audiofondo2 = new Audio("fondo2.mp3");
const casi = new Audio("60sec.mp3");
let cont = 0;
let tiempo = 4;
let timer;
let tiempo2 = 100;
...
function abrir2() {
    ...
    const intervalo = setInterval(function () {
        ...
        if (tiempo == -2) {
            ...
            audiofondo2.volume = 0.2;
            audiofondo.play();
            audiofondo2.play();
            audiofondo2.muted = true;
        }
    }, 1000);
}
...
function gameover() {
    ...
    setTimeout(function () {
        document.getElementById("modalxd2").showModal();
        audiofinal.loop = true;
        audiofinal.play();
        audiofinal.volume = 0.2;
        createLeaves();
        animate();
    }, 1000)
}
